        ...
        if (now_us >= next_publish_us) {
            ...
            }
            {
                ...
                sdacs_features_t features = {
                    ...
                    .f_peak_full_hz = metrics.f_peak_full_hz,
                    .f_peak_acoustic_hz = metrics.f_peak_acoustic_hz,
                    .f_peak_acoustic_energy = metrics.f_peak_acoustic_energy,
                    .tone_1khz_energy = metrics.tone_1khz_energy,
                    ...
                    .band_bass_energy = metrics.band_bass_energy,
                    .band_low_mid_energy = metrics.band_low_mid_energy,
                    .band_mid_energy = metrics.band_mid_energy,
                    .band_presence_energy = metrics.band_presence_energy,
                    .band_high_energy = metrics.band_high_energy,
                    .band_sub_ratio = metrics.band_sub_ratio,
                    .band_bass_ratio = metrics.band_bass_ratio,
                    .band_low_mid_ratio = metrics.band_low_mid_ratio,
                    .band_mid_ratio = metrics.band_mid_ratio,
                    .band_presence_ratio = metrics.band_presence_ratio,
                    .band_high_ratio = metrics.band_high_ratio,
                    .band_sub_peak_hz = metrics.band_sub_peak_hz,
                    .band_bass_peak_hz = metrics.band_bass_peak_hz,
                    .band_low_mid_peak_hz = metrics.band_low_mid_peak_hz,
                    .band_mid_peak_hz = metrics.band_mid_peak_hz,
                    .band_presence_peak_hz = metrics.band_presence_peak_hz,
                    .band_high_peak_hz = metrics.band_high_peak_hz,
                    .band_sub_peak_energy = metrics.band_sub_peak_energy,
                    .band_bass_peak_energy = metrics.band_bass_peak_energy,
                    .band_low_mid_peak_energy = metrics.band_low_mid_peak_energy,
                    .band_mid_peak_energy = metrics.band_mid_peak_energy,
                    .band_presence_peak_energy = metrics.band_presence_peak_energy,
                    .band_high_peak_energy = metrics.band_high_peak_energy,
                    .dominant_band_ratio = metrics.dominant_band_ratio,
                    .dominant_band_peak_hz = metrics.dominant_band_peak_hz,
                ...
                strncpy(features.dominant_band_name,
                        metrics.dominant_band_name,
                        sizeof(features.dominant_band_name) - 1);
                features.dominant_band_name[sizeof(features.dominant_band_name) - 1] = '\0';
