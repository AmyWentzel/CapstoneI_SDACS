/*
 * SDACS module: Public node identity interface
 *
 * Purpose:
 *   Exposes identity validation and deterministic BLE/MQTT naming helpers.
 *
 * Design note:
 *   Runtime NVS identity is intentionally not part of this interface.
 *
