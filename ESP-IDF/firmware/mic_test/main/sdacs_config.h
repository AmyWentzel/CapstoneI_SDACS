...
#define SDACS_FUEL_GAUGE_SDA_GPIO        SDACS_TEMP_HUMIDITY_SDA_GPIO
#define SDACS_FUEL_GAUGE_SCL_GPIO        SDACS_TEMP_HUMIDITY_SCL_GPIO
#define SDACS_FUEL_GAUGE_FREQ_HZ         SDACS_TEMP_HUMIDITY_FREQ_HZ
