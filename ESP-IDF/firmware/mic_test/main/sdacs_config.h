...
#define SDACS_SENSOR_I2C_PORT            0
#define SDACS_SENSOR_I2C_SDA_GPIO        47
#define SDACS_SENSOR_I2C_SCL_GPIO        48
#define SDACS_SENSOR_I2C_FREQ_HZ         100000

#define SDACS_TEMP_HUMIDITY_I2C_PORT     SDACS_SENSOR_I2C_PORT
#define SDACS_TEMP_HUMIDITY_SDA_GPIO     SDACS_SENSOR_I2C_SDA_GPIO
#define SDACS_TEMP_HUMIDITY_SCL_GPIO     SDACS_SENSOR_I2C_SCL_GPIO
#define SDACS_TEMP_HUMIDITY_FREQ_HZ      SDACS_SENSOR_I2C_FREQ_HZ
#define SDACS_TEMP_HUMIDITY_ADDR         0x44
#define SDACS_TEMP_HUMIDITY_PERIOD_MS    2000

#define SDACS_FUEL_GAUGE_ENABLED         1
#define SDACS_FUEL_GAUGE_I2C_PORT        SDACS_SENSOR_I2C_PORT
#define SDACS_FUEL_GAUGE_SDA_GPIO        SDACS_SENSOR_I2C_SDA_GPIO
#define SDACS_FUEL_GAUGE_SCL_GPIO        SDACS_SENSOR_I2C_SCL_GPIO
#define SDACS_FUEL_GAUGE_FREQ_HZ         SDACS_SENSOR_I2C_FREQ_HZ
#define SDACS_FUEL_GAUGE_ADDR            0x36
#define SDACS_FUEL_GAUGE_PERIOD_MS       5000
