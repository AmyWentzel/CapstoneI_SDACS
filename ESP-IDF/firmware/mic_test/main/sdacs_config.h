...
#define SDACS_I2S_DEBUG_LOGS             0
#define SDACS_FEATURE_VERBOSE_LOGS       0
#define SDACS_CAPTURE_LOG_EVERY_N_ROWS   5
...
#define SDACS_TONE_1KHZ_CONTRAST_MIN_HZ  500.0f
#define SDACS_TONE_1KHZ_CONTRAST_MAX_HZ  1500.0f
#define SDACS_TONE_1KHZ_CONTRAST_THRESHOLD_DB 6.0f
#define SDACS_TONE_1KHZ_MIN_LOCAL_RATIO  2.0f
